      ...
      >
        <VStack spacing={6} align="flex-start" pointerEvents="all" maxW="lg">
          <Heading size="4xl" color="teal.600">
            The New Standard in Nurse Upleveling
          </Heading>
          <Text fontSize="xl" color="gray.600">
            The premier platform for nursing credentialing. Earn certificates
            through professional interviews and uplevel your career.
          </Text>
